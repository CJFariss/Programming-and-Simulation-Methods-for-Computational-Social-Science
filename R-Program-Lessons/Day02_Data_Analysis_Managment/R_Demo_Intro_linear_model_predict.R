## R_Demo_Intro_linear_model_predict.R
##########################################################################
...
##
## (1) Demonstrates how to use the predict() function after fitting a linear model with the lm() function.
##
##########################################################################


## LOAD DATA INTO AN R SESSION
macro <- read.csv("Datasets/macro.csv", header=TRUE)
