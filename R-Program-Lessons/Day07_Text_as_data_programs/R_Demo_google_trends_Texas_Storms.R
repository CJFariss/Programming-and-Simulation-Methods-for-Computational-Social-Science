...
##
## Examples taken from:
## Chen, Ted Hsuan Yun, Christopher J. Fariss, Hwayong Shin, and Xu Xu. “Disaster Experience Mitigates the Partisan Divide on Climate Change: Evidence from Texas”.
##
## Available here: https://osf.io/ftb8g
##
##########################################################################
